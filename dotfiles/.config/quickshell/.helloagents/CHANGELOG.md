...
- **[Bar 测试原型]**: 新增与生产 Bar 隔离的 `tests/` Edge-Integrated Contoured Bar 预览，包含左/中/右三功能区，右侧含 Metrics/Tray/Power 三个相邻下伸子舱与固定 mock，不接入生产服务。
...
- Edge-Integrated Bar 原型门禁通过：固定 mock 下覆盖 2048/1600/1280/800 宽度，验证左/中/右三功能区及右侧 Metrics/Tray/Power 三个相邻下伸子舱边界与内容不溢出；预览不会连接生产采集链路。
